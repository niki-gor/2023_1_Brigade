import { routes, Route, ComponentTemplate, urlInfo} from '@router/routes';
...
class Router {
    ...
    /**
     * Можем указать url нового Route-a как в переменной path, так и задать в самом объектк newRoute
